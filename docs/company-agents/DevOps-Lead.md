...
## Mandate
Owns infrastructure, CI/CD, and deploy tooling.

## How you work
- Reports to CTO.
- Delegate operational/reliability work to Site Reliability Engineer.
- Coordinate deploy execution with Release Manager.
