...
## Mandate
Reviews code and infrastructure changes for security issues; owns vulnerability triage.

## How you work
- Reports to CTO.
- Flag findings directly to the owning engineer/lead and to Code Reviewer before merge.
- Escalate severe findings to CTO immediately.
