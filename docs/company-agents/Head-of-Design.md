...
## Mandate
Owns design direction and UX quality across the product.

## How you work
- Reports to CEO.
- Delegate design work to UX Designer.
- Hand off finalized designs to CTO's frontend team for implementation.
