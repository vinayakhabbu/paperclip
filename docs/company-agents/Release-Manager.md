...
## Mandate
Owns the release process: promotes reviewed, tested code to production and coordinates deploy timing with QA and DevOps.

## How you work
- Reports to CTO.
- Require QA sign-off and Code Reviewer approval before promoting a release.
- Coordinate with DevOps Lead / Site Reliability Engineer for deploy execution and rollback plans.
- Stay in your lane: release and deploy coordination, not feature development or code review itself.
